...
//        animators.addListener();
    ...
    public void setMaxOffset(int maxOffset) {
        this.maxOffset = mSpecificHeight - maxOffset;
    }

    public void setExitOffset(int exitOffset) {
        this.exitOffset = mSpecificHeight - exitOffset;
    }

    public void setSpecificHeight(int specificHeight){//具体的整个控件的大小,需要首先设置
        this.mSpecificHeight = specificHeight;
    }
